$(document).ready(function() {	
	...
	var mymap = L.map('mapid').setView([41.5504024, 2.0814082], 15);
	...
	$.getJSON("/data/map.geojson",function(data){
		...
		var datalayer = L.geoJson(data ,{
			...
			onEachFeature: function(feature, featureLayer) {
				featureLayer.bindPopup("<div class=\'infoWindows\'><b>Zona d'entrenament</b><br>Parc Catalunya<br>Circuit 500m</div>");
			}
		}).addTo(mymap);
	});
});